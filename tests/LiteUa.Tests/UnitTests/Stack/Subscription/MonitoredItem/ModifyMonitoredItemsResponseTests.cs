...
{
    [Trait("Category", "Unit")]
    public class ModifyMonitoredItemsResponseTests
    {
        ...
        {
            Assert.Equal(766u, ModifyMonitoredItemsResponse.NodeId.NumericIdentifier);
        }
        ...
        public void Decode_BasicResponse_ParsesResults()
        {
            ...
            _readerMock.SetupSequence(r => r.ReadUInt32())
                ...
                .Returns(0u)    // Item StatusCode
                .Returns(10u);  // Item RevisedQueueSize

            _readerMock.Setup(r => r.ReadDouble()).Returns(500.0); // RevisedSampling
